...
// 無駄になる。あちらは TCRtiInteractionToHla — accept() で詰め替えて sendInteraction を呼ぶだけ。
//
...
class TCRtiObjectToHla : public TCToHla<T> {
public:
    ...
    TCRtiObjectToHla(KeyOf keyOf, Create create, Write write)
